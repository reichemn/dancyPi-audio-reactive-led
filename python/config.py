...
"""Device used to control LED strip. Must be 'arduino', 'simulator', 'arduino&simulator', 'pi', 'esp8266' or 'blinkstick'
...
if DEVICE == 'arduino' or DEVICE == 'arduino&simulator':
    # use python -m serial.tools.list_ports to list all available serial ports
    SERIAL_PORT = '/dev/cu.usbserial-1410'
    SOFTWARE_GAMMA_CORRECTION = True
    STRIP_BRIGHTNESS = 1.0 
    """Brightness of LED strip between 0 and 1"""
